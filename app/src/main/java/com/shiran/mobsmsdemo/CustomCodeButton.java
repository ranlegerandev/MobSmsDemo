...
public class CustomCodeButton extends Button {
    ...
    public CustomCodeButton(Context context) {
        this(context, null);
    }

    public CustomCodeButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomCodeButton(Context context, AttributeSet attrs, int defStyleAttr) {
